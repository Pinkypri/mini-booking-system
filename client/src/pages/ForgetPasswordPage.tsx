...
import { requestForgetPassword, clearForgetPasswordState } from "../store/auth/forgetpassword/forgetPasswordReducer";
...
const ForgetPasswordPage: React.FC = () => {
  ...
  const forgetPassword = useSelector((state: RootState) => state.forgetPassword);
  const { isLoading, successMessage, error } = forgetPassword;
  ...
  const onFinish = (values: ForgetPasswordFormData) => {
        ...
        >
          ...
          <div className="p-8">
            ...
            >
              ...
              <Form.Item
                name="newPassword"
                label={<span className="text-gray-800 font-semibold text-sm">New Password</span>}
              ...
              <Form.Item
                ...
                label={<span className="text-gray-800 font-semibold text-sm">Confirm New Password</span>}
